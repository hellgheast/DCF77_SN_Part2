...
int main(int argc, char **argv)
{
    ...
    design_a_1696344234_0632001823_init();
    design_a_1936778869_2730021763_init();
    design_a_2859655062_2730021763_init();


    xsi_register_tops("design_a_2859655062_2730021763");
